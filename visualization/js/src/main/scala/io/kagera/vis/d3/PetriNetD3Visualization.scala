 ...
 */
class PetriNetD3Visualization(element: String, petriNetModel: ColoredPetriNet, placeRenderer: VertexRenderer = defaultPlaceRenderer, transitionRenderer: VertexRenderer = PetriNetD3Visualization.defaultTransitionRenderer) {
