...
object Dependencies {
  ...
  val zioActorsVersion = "0.10.3-SNAPSHOT"
  ...
  val fs2Core = Def.setting("co.fs2" %%% "fs2-core" % "3.1.1")
  val catsCore = Def.setting("org.typelevel" %%% "cats-core" % "2.6.1")
  val catsEffect = Def.setting("org.typelevel" %%% "cats-effect" % "2.1.4")
  ...
  val zioInteropCats = Def.setting("dev.zio" %%% "zio-interop-cats" % "2.1.4.0")
  val zioTest = Def.setting("dev.zio" %%% "zio-test" % zioVersion)
  val zioTestSbt = Def.setting("dev.zio" %%% "zio-test-sbt" % zioVersion)
  val zioActors = Def.setting("dev.zio" %%% "zio-actors" % zioActorsVersion)
  val zioActorsPersistence = Def.setting("dev.zio" %%% "zio-actors-persistence" % zioActorsVersion)
