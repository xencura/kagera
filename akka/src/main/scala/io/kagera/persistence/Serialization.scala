...
class Serialization(serializer: ObjectSerializer) {
  ...
  def deserializeEvent[S](e: AnyRef): Instance[S] => EventSourcing.Event =
    instance =>
      e match {
        case e: messages.Initialized => deserializeInitialized(instance, e)
        case e: messages.TransitionFired => deserializeTransitionFired(e)(instance)
        case e: messages.TransitionFailed => deserializeTransitionFailed(e)(instance)
      }
  ...
  private def deserializeInitialized[S](instance: Instance[S], e: messages.Initialized): InitializedEvent = {
